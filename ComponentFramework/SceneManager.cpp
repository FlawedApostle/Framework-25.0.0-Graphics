...
bool SceneManager::Initialize(std::string name_, int width_, int height_) {
	...
	/********************************   Default first scene   ***********************/
	//BuildNewScene(SCENE_NUMBER::SCENE0g);				/// No longer exists
		...
		if (sdlEvent.type == SDL_EventType::SDL_QUIT) {
			...
			case SDL_SCANCODE_KP_MULTIPLY:
				...
				(
					"List Of Scenes::\n"
					"GRAPHICS\n"																			
					" Scene 1g (1) - Graphics Phong Lighting Baseline\n"
					" Scene 2g (2) - Phong Lightning PT0\n"
					" Scene 3g (3) - Phong Lightning PT1\n"
					" Scene 4g (4) - Skull Texture Model Matrix PT0\n"
				...
				break;
			case SDL_SCANCODE_1:
				printf("Scene 1g - Graphics Phong Lighting Baseline\n");
				BuildNewScene(SCENE_NUMBER::SCENE1g);
				break;
			case SDL_SCANCODE_2:
				printf("Scene 2g - Phong Lightning PT0\n");
				BuildNewScene(SCENE_NUMBER::SCENE2g);
				break;
			case SDL_SCANCODE_3:	// phong lighting refined pt 0
				printf("Scene 3g - Phong Lightning PT1\n");
				BuildNewScene(SCENE_NUMBER::SCENE3g);
				break;
...
bool SceneManager::BuildNewScene(SCENE_NUMBER scene) {
	...
	case SCENE_NUMBER::SCENE1g:
		...
		break;
	case SCENE_NUMBER::SCENE2g:						// Phong Lighting
		currentScene = new Scene2g();
		status = currentScene->OnCreate();
		break;
	case SCENE_NUMBER::SCENE3g:						// Parenting / Matrix
